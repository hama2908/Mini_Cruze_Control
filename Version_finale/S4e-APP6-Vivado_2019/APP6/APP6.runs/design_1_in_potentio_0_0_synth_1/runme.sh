...
HD_PWD='C:/Mini_Cruze_Max/S4e-APP6-Vivado_2019/APP6/APP6.runs/design_1_in_potentio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_in_potentio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_in_potentio_0_0.tcl
